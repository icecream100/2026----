...
window.MockStore = (function () {
  ...
  var SEED_EVENTS = [
    ...
    { id: 'AE20260714-005', rule: '聚集·食堂就餐区（100/5m）', type: '聚集', group: '食堂就餐区', level: '警告', threshold: 100, triggerTime: '2026-07-14 18:30:44', triggerCount: 105, curCount: 0, recoverTime: '2026-07-14 18:36:12', status: '已处理', confirmUser: '管理员·王', confirmTime: '2026-07-14 18:32:00', handleResult: '已处理', handleRemark: '自动恢复，人数回落至阈值以下', handleUser: '系统', handleTime: '2026-07-14 18:36:12', sla: '5分28秒' }
  ];
